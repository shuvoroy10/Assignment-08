...
const AppsDetails = () => {
  ...
  return (
    ...
    <div className="container mx-auto">
      ...
      <div className="flex flex-col lg:flex-row bg-gray-50 p-4 items-center my-6 gap-0 lg:gap-35">
        <div>
          <img
      ...
      <div className="bg-base-100 border rounded-xl p-4 h-80 mb-9 rotate-270 lg:rotate-0 ">
